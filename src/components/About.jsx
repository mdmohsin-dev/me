                ...
                <div className="w-full flex flex-col lg:flex-row xl:gap-16 gap-10">
                    ...
                    <div className="bg-[#0f0f0f] border border-gray-800 rounded-2xl md:p-8 p-3 shadow-2xl lg:w-2/3">
                        ...
                        <div className="mb-10">
                            ...
                            <p className="text-gray-300 leading-relaxed pl-6">
                                My mission is to build scalable and user-focused web applications that solve real-world problems. As a Full Stack Developer, I continuously expand my expertise in backend systems, authentication, and databases while crafting modern frontend experiences. I aim to deliver clean, efficient, and high-performance full-stack solutions.
                            </p>
                        </div>
